...
//Borro las filas
  ...
  public static function cuenta() {
    require_once 'conexion.php';
    $conexion = Inmobiliaria::conectar();
    $count_query = $conexion->query("SELECT * FROM propiedad");
...
//El get que muestra la lista de los inmueble
  public static function getListInmueble() {
    ...
    $seleccion = "SELECT Referencia,DATE_FORMAT(FechaAlta,'%d/%m/%Y') as FechaAlta,Tipo,Operacion,Provincia,Superficie,Precio,Imagen,Vendedor FROM propiedad ORDER BY Referencia LIMIT $offset,$per_page";
