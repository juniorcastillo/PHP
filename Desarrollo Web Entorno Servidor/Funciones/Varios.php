        ...
        <form action="Varios.php" method="post">
            ...
            <label for="dato1">valor2</label>
                ...
                if (isset($_REQUEST['aceptar'])) {
                    ...
                    //Prueba la funcion el digito N que lo devuelve contando de atras para adelante

                    $digito = digitoN($valor1, $valor2);
                    echo '<br>Este es el digito del valor1 -->' . $digito . '<br>';

                    //Prueba la funcion posicion de digito n  


                    echo 'La posicion del digito es ' . posicionDeDigito($valor1, $valor2);
                }
...
// Funciones ///////////////////////////////////////////////
                 ...
                 * @return <code>true</code> si el número es primo
                 */
                function digitoN($numeroIntroducido, $posicion) {


                    $digito = 1; //primer contador
                    $auxposic; //la auxilliar de las posiciones (el tamaño)
                    $i = 0; // guarda el digito N pero tambien si hay detras de el los guarda
                    $aux = 0; // esta yah guarda el digito N sin sobras.
                    ...
                    while ($numeroIntroducido > 0) {
                        ...
                        $numeroIntroducido = floor($numeroIntroducido / 10);


                        $digito++;
                    }
                    $x = 1; //segundo contador
                    $auxI = voltea($i); //volteo el numero denuevo para eliminar los que sobran y los guardo en auxI
                 ...
                 * @return 
                 */
                function posicionDeDigito($numeroIntroducido, $digito) {


                    $posicion = 1;
                    $P = -1;
                    $numero = voltea($numeroIntroducido);

                    // comprueba la posición
                    while ($numero > 0) {

                        if (floor($numero % 10) == $digito) {
                 ...
                 * @return <code>true</code> si el número es primo
                 */
                function quitaPorDetras($digitosIntro, $n) {
                    $num = 1;

                    while ($num <= $n) {
                        $n--; // N es la cantidad de digitos que le quitaran
                        $digitosIntro = floor($digitosIntro / 10);
                    }
